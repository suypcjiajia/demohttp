...
void strcpy_s(void * p, int len, const void *s){
    strncpy((char*)p,(const char *)s,len);
}
bool safeAddToOutbuf(char* outbuf,int &iOutbuf,char* pinyinValue,int iPinyinValue) {
...
const char *_pinyin_table_[20902] = {
    ...
    void pinyin_utf8(char* inbuf,char* outbuf, bool m_blnSimaple,bool polyphone_support,bool m_blnFirstBig,bool m_blnAllBiG,bool m_LetterEnd, bool m_unknowSkip,bool m_filterPunc)
    {
...
void pinyin_gb2312(char * inbuf, char * outbuf, bool m_blnSimaple , bool polyphone_support , bool m_blnFirstBig , bool m_blnAllBiG , bool m_LetterEnd , bool m_unknowSkip , bool m_filterPunc ) {
