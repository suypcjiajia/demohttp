...
{
    aos_str_set(&config->endpoint, "oss-cn-shenzhen.aliyuncs.com");
    aos_str_set(&config->access_key_id, "AxIqe7mZCp09FXy5");
    aos_str_set(&config->access_key_secret, "zRmdYJdjIMLGFBbF5yVWYBGg0IoDtt");
